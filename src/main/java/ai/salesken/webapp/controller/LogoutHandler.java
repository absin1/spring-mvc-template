 ...
 * {@linkplain org.springframework.security.core.context.SecurityContext} and
 * the session. This controller will also log users out of Auth0 by calling the
 * <a href=
...
public class LogoutHandler extends SecurityContextLogoutHandler {
	 ...
	 * can look up information about the configured provider to call the Auth0
	 * logout endpoint. Called by the Spring framework.
	 *
	 ...
	 * the application, and then logs the user out of Auth0.
	 *
